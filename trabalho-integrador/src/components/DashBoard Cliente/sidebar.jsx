...
import { HouseLine, PencilLine, FileText, CloudArrowUp, Gear, SignOut} from "@phosphor-icons/react";
        ...
        <div className="sidebar">
            ...
            <div>
                ...
                <button className="sidebarButton">
                    ...
                    <Link className="link__buttonSidebar" to="/dashboard-cliente">Registrar</Link>
                </button>
