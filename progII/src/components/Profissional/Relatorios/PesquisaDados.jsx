                ...
                <nav className="TopBarPesquisa">
                    <div>
                        <select id="cultivarSelect">
                            <option value="" disabled selected>Cultivar</option>
                            <option value="cultivar1">hiperprecoce</option>
                            <option value="cultivar2">superprecoce</option>
                            <option value="cultivar3">semiprecoce</option>
                            <option value="cultivar4">precoce</option>
                            <option value="cultivar5">normal</option>
                            <option value="cultivar6">híbrido</option>
                        </select>
                    </div>
                </nav>
